...
class DataIngestion:
    ...
    def export_data_into_feature_store_file(self) -> Path:
        ...
        try :
            ...
            raw_file_path = self.dataingestion.artifact_folder

            sensor_data = self.export_collection_as_dataframe(
                db_name=MONGO_DB_NAME, 
                collection_name=MONGO_COLLECTION_NAME
            )
            logging.info(f"Saving exported data to raw file path : {raw_file_path}")
    ...
    def initate_data_ingestion (self) -> Path :
        ...
        logging.info("Entered intiate_data_ingestion process of DataIngestion class")
        try :
